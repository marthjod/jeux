...
public class CalcGamesBean implements CalcGamesRemote, CalcGamesLocal {
    ...
    private List<IGame> calcGamesForGroup(IGroup group, boolean shuffledMode) {
        ...
        // need at least 2 players for binomial coefficient
        if (group != null && group.getPlayers().size() > 1) {
            ...
            if (shuffledMode) {
                Deque<IPlayer> breakroom = new ArrayDeque<>();
            ...
            logger.error("Cannot calculate games, group does not exist or has less than 2 players.");
        }
    ...
    public String getShuffledGamesList(IGroup group, String format,
        ...
        if (group != null && group.getPlayers().size() >= 2) {
            ...
            if (FORMAT_LATEX.equals(formatToUse)) {
